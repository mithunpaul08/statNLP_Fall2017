...
def test(theta,filename,vectorizer):
    ...
    try:
        ...
        featureVector=vectorizer.transform(testing_data["data"] ).toarray()
        ...
        pred_int=[]
        gold_int=[]
        #featureVector_new=featureVector[:,1:]
        ...
        for x in featureVector:
            ...
            #print("shape of theta before:"+str((theta.shape)))
            #theta=np.array([theta])
            #print("shape of theta:"+str((theta.shape)))
            #print("shape of x:"+str((x.shape)))
            #print("type of x:" + str(type(x)))
            #print("type of theta:" + str(type(theta)))
            #x=np.array(x)[0]
